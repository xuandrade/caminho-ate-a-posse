...
{ label: 'Horas semana', value: weekHours.toFixed(1), goal: shared.goals.weeklyHours, unit: 'h', color: 'var(--tinta)', glow: '#7B67D8', icon: <I.target size={14} /> },
...
<button className="btn-ghost" onClick={() => { remove(editingC.id); setEditing(null); }} style={{ color: 'var(--coral)' }}><I.close size={11} /> Remover</button>
</div>
</div>
)}
<div style={{
...
if (days !== null && days < 30) { color = 'var(--coral)'; glow = '#FF7070'; }
